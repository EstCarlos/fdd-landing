      ...
      <div className="container space-y-12 px-4 md:px-6">
        ...
        <div className="mx-auto grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <Vacancie
            ...
            description="Buscamos personas responsables para formar parte de nuestro equipo de seguridad durante la temporada de béisbol invernal 2024-2025. Si tienes experiencia en seguridad y te apasiona el deporte, ¡aplica ahora!"
          />
